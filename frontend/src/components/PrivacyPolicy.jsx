    ...
    <>
      ...
      <main className="max-w-[1000px] mx-auto px-6 md:px-12 py-12 md:py-32 min-h-screen">
        ...
        <header className="mb-12 md:mb-20 text-center">
          <h1 className="text-4xl md:text-7xl font-bold tracking-tighter text-on-surface mb-8 leading-[1.1]">
            Privacy at the heart of the <span className="text-primary-container">15-Minute City</span>.
          </h1>
        </header>
        ...
        <div className="space-y-16 md:space-y-24">
          ...
          <section className="scroll-mt-32" id="collection">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-primary-container flex items-center justify-center text-on-primary-container">
                <span className="material-symbols-outlined">dataset</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-on-surface">Information Collection</h2>
            </div>
            <div className="bg-surface-container-lowest rounded-3xl p-6 md:p-12 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 pt-6">
                <div className="p-6 rounded-2xl bg-surface">
                  ...
                  <p className="text-sm text-on-surface-variant">Name, email, and preferred transit modes provided during your 15-Minute City account setup.</p>
                </div>
                <div className="p-6 rounded-2xl bg-surface">
          ...
          <section className="scroll-mt-32" id="usage">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-on-surface">Data Usage</h2>
            </div>
          ...
          <section className="scroll-mt-32" id="rights">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-on-surface">User Rights</h2>
            </div>
            <div className="bg-primary text-white rounded-3xl p-8 md:p-10 shadow-xl shadow-primary/10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div>
                  <h3 className="text-xl md:text-2xl font-bold mb-6">Your Sovereignty</h3>
                  <p className="opacity-90 leading-relaxed mb-8 text-sm md:text-base">
                    In the 15-Minute City ecosystem, you own your data. You have the right to access, rectify, or erase your personal information at any time.
                  </p>
                </div>
          ...
          <section className="scroll-mt-32 bg-surface-container-low rounded-3xl p-6 md:p-12" id="security">
            <div className="max-w-2xl">
              <h2 className="text-xl md:text-2xl font-bold text-on-surface mb-4">Security & Architecture</h2>
              <p className="text-sm md:text-base text-on-surface-variant mb-8">
                We employ AES-256 encryption for all data at rest and TLS 1.3 for all data in transit. Our servers are located in carbon-neutral data centers within the jurisdiction of the UK.
              </p>
            </div>
          </section>
        </div>
