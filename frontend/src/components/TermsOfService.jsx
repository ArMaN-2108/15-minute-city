...
const TermsOfService = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 w-full z-50 backdrop-blur-xl shadow-2xl shadow-emerald-900/10 flex justify-between items-center px-4 md:px-8 h-20 w-full max-w-none" style={{ backgroundColor: '#10b981' }}>
            ...
            <main className="max-w-4xl mx-auto px-6 md:px-12 py-32">
                ...
                <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-12">
                    <div className="max-w-2xl">
                        <h1 className="text-[2.5rem] md:text-[3.5rem] font-bold leading-none tracking-tight text-on-surface">
                            Terms of <span className="text-primary">Service</span>
                        </h1>
                    </div>
                    <div className="md:text-right">
                        <p className="text-[10px] md:text-sm font-semibold text-on-surface-variant uppercase tracking-widest">Last Updated</p>
                        <p className="text-xl md:text-2xl font-bold text-primary">April 07, 2026</p>
                    </div>
                </header>
                ...
                <div className="space-y-16 md:space-y-24 pb-32">
                    ...
                    <section className="scroll-mt-32" id="acceptance">
                        <div className="flex flex-col gap-6">
                            <h2 className="text-xl md:text-[1.75rem] font-semibold text-on-surface flex items-center gap-4">
                                <span className="material-symbols-outlined text-primary text-2xl md:text-3xl p-3 bg-surface-container-low rounded-2xl">verified_user</span>
                                01. Acceptance of Terms
                            </h2>
                            <div className="bg-surface-container-lowest p-6 md:p-12 rounded-3xl space-y-6 text-on-surface-variant leading-loose border-l-4 border-primary shadow-sm">
                                <p className="text-sm md:text-base">
                                    By accessing or using the <span className="font-bold text-on-surface">15-Minute City</span> platform, including our mobile applications, web portals, and 15-minute city infrastructure services, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you are prohibited from using our services.
                                </p>
                                <p className="text-sm md:text-base">
                    ...
                    <section className="scroll-mt-32" id="responsibilities">
                        <div className="flex flex-col gap-6">
                            <h2 className="text-xl md:text-[1.75rem] font-semibold text-on-surface flex items-center gap-4">
                                <span className="material-symbols-outlined text-primary text-2xl md:text-3xl p-3 bg-surface-container-low rounded-2xl">groups</span>
                                02. User Responsibilities
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-surface-container p-6 md:p-8 rounded-3xl hover:bg-surface-container-high transition-colors">
                                    ...
                                    <p className="text-sm text-on-surface-variant leading-relaxed">Users are responsible for maintaining the confidentiality of their login credentials and all activities occurring under their 15-Minute City account.</p>
                                </div>
                                <div className="bg-surface-container p-6 md:p-8 rounded-3xl hover:bg-surface-container-high transition-colors">
                                ...
                                <div className="bg-surface-container p-6 md:p-8 rounded-3xl hover:bg-surface-container-high transition-colors md:col-span-2">
                                    ...
                                    <ul className="space-y-4 text-sm text-on-surface-variant">
                                        <li className="flex items-center gap-3">
                                            ...
                                            Circumventing any technological measure implemented by 15-Minute City.
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="material-symbols-outlined text-error text-sm">block</span>
                    ...
                    <section className="scroll-mt-32" id="liability">
                        <div className="flex flex-col gap-6">
                            <h2 className="text-xl md:text-[1.75rem] font-semibold text-on-surface flex items-center gap-4">
                                <span className="material-symbols-outlined text-primary text-2xl md:text-3xl p-3 bg-surface-container-low rounded-2xl">gavel</span>
                                03. Limitations of Liability
                            </h2>
                            <div className="bg-white p-6 md:p-12 rounded-3xl shadow-2xl shadow-emerald-900/5 space-y-8">
                                <p className="text-sm md:text-base text-on-surface-variant leading-loose italic border-l-2 border-emerald-100 pl-6">
                                    "15-Minute City provides its services on an 'as-is' and 'as-available' basis. We make no warranties, expressed or implied, regarding the continuous availability or absolute accuracy of our urban data modeling."
                                </p>
                                <div className="text-sm text-on-surface-variant space-y-6">
                                    <p>
                                        To the maximum extent permitted by law, <span className="font-bold">15-Minute City</span>, its directors, employees, and partners shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
                                    </p>
                                    <p>
                    ...
                    <section className="bg-primary p-8 md:p-12 rounded-3xl text-on-primary flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                        <div className="max-w-md">
                            <h2 className="text-xl md:text-2xl font-bold mb-2">Have legal questions?</h2>
                            <p className="opacity-80 text-sm">Our legal and governance team is ready to assist you with any clarifications regarding these terms.</p>
                        </div>
                        <Link to="/contact" className="bg-on-primary text-primary px-10 py-4 rounded-full font-bold hover:scale-[1.05] transition-transform shadow-xl">
                            Contact Support
                        </Link>
                    </section>
                </div>
