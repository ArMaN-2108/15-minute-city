...
const ContactUs = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl shadow-2xl shadow-emerald-900/10 flex justify-between items-center px-4 md:px-8 h-20 bg-[#10b981]">
      ...
      <main className="flex-grow max-w-[1440px] mx-auto px-6 md:px-12 pt-32 pb-32">

        <section className="mb-16 md:mb-24 flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl md:text-[3.5rem] font-bold tracking-tight text-on-surface leading-[1.1]">
              Let's Build the <br/>
              <span className="text-primary italic">15-Minute City</span> Together.
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 bg-surface-container-low p-6 md:p-10 rounded-3xl">
            <form className="space-y-6 md:space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] md:text-xs font-semibold tracking-widest uppercase text-on-surface-variant px-2">Full Name</label>
                  <input className="w-full h-14 md:h-16 bg-surface-container-lowest border-none rounded-2xl px-6 focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-on-surface-variant/30 text-on-surface" placeholder="John Doe" type="text"/>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] md:text-xs font-semibold tracking-widest uppercase text-on-surface-variant px-2">Email Address</label>
                  <input className="w-full h-14 md:h-16 bg-surface-container-lowest border-none rounded-2xl px-6 focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-on-surface-variant/30 text-on-surface" placeholder="john@15minutecity.co.uk" type="email"/>
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] md:text-xs font-semibold tracking-widest uppercase text-on-surface-variant px-2">Subject</label>
                <select className="w-full h-14 md:h-16 bg-surface-container-lowest border-none rounded-2xl px-6 focus:ring-4 focus:ring-primary/10 transition-all text-on-surface appearance-none">
              ...
              <div className="space-y-2">
                <label className="text-[10px] md:text-xs font-semibold tracking-widest uppercase text-on-surface-variant px-2">Message</label>
              ...
              <button className="w-full md:w-auto px-12 h-14 md:h-16 bg-gradient-to-br from-primary to-primary-container text-on-primary rounded-full font-bold text-lg shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all" type="submit">
                Send Message
              </button>
            </form>
          </div>
          ...
          <div className="lg:col-span-5 space-y-12">
            <div className="bg-surface-container-highest p-8 md:p-10 rounded-3xl space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-on-surface-variant">hello@15minutecity.co.uk</p>
                  <p className="text-on-surface-variant text-[10px] md:text-sm mt-1">Response within 24 hours</p>
                </div>
              </div>
              <div className="flex items-start gap-6">
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-lg text-on-surface mb-1">15-Minute City Headquarters</h4>
                  <p className="text-sm md:text-base text-on-surface-variant">London, United Kingdom</p>
                </div>
              </div>
            </div>

            <div className="space-y-6">
              <h3 className="text-xs font-bold tracking-widest uppercase text-on-surface-variant">Connect with me:</h3>
              <div className="grid grid-cols-3 gap-4 md:gap-6">
                <a className="group bg-surface-container-low p-4 md:p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-primary hover:text-white transition-all duration-300" href="https://www.linkedin.com/in/arman-shk/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="group bg-surface-container-low p-4 md:p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-primary hover:text-white transition-all duration-300" href="https://arman-shk.vercel.app/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="group bg-surface-container-low p-4 md:p-6 rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-primary hover:text-white transition-all duration-300" href="https://github.com/ArMaN-2108" target="_blank" rel="noopener noreferrer">
