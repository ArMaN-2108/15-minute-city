...
<input className="w-full h-16 bg-surface-container-lowest border-none rounded-2xl px-6 focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-on-surface-variant/30 text-on-surface" placeholder="john@15minutecity.co.uk" type="email"/>
</div>
</div>
<div className="space-y-2">
...
<p className="text-on-surface-variant">hello@15minutecity.co.uk</p>
