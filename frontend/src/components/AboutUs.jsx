      ...
      <main className="pt-32">
        ...
        <section className="px-12 max-w-screen-2xl mx-auto mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-7">
              <h1 className="text-[3.5rem] leading-[1.1] font-bold text-on-surface tracking-tighter mb-8">
                The world is better <br />
                <span className="text-primary">at human scale.</span>
              </h1>
              <p className="text-xl text-on-surface-variant max-w-xl leading-relaxed">Urban life is being redesigned around the principle that essential needs—work, grocery, education, and health—should be accessible within a 15-minute walk or bike ride from home.</p>
            </div>
            <div className="lg:col-span-5 flex justify-end">
              <div className="w-full h-[400px] bg-surface-container rounded-3xl overflow-hidden relative shadow-xl">
                <img className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" data-alt="Modern sustainable urban street with lush greenery, bicycle lanes, and people walking in a clean European city environment" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDKd46SK6nIGinsZWuwtwHZ_cQedkgG4k2VAMxBsTh_xjLCJc6A_koJMy_h3BN8O-_WdByglNCgBoVrt9_yv1YA859YWE7FNunx5rZGKAroZXKabbHHq_jKdBnE0r074RXo9272LZmuBSj0PE65FieuoSgCO_d5eNC8TzadZqc-l7snEr5eEJ_TJ1tglFkNOhQV0WlwElvyzw_FzrZCRo_CgkRTDQaegFSw8MQzgg_5DupAfK5hOXd4r-UD6uCBCrkN22auPH2RL6M" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-12 max-w-screen-2xl mx-auto mb-32">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-surface-container-lowest p-10 rounded-2xl shadow-[0_20px_40px_-10px_rgba(0,33,21,0.06)] flex flex-col justify-between aspect-square group hover:bg-primary transition-all duration-500">
            ...
            <div className="bg-surface-container-low p-10 rounded-2xl flex flex-col justify-between aspect-square border-none relative overflow-hidden group">
            ...
            <div className="bg-surface-container-high p-10 rounded-2xl flex flex-col justify-between aspect-square">
              <div className="flex flex-col gap-6">
          ...
          <div className="px-12 max-w-screen-2xl mx-auto">
            <div className="flex flex-col md:flex-row gap-20">
              <div className="md:w-1/3">
                ...
                <h2 className="text-3xl font-bold text-on-surface">Data-Driven Urbanism</h2>
              </div>
              <div className="md:w-2/3 space-y-8">
                <p className="text-xl text-on-surface-variant leading-relaxed">Advanced geospatial analysis is utilized to map the accessibility of cities worldwide. Proximity of residential zones is measured against six essential pillars: social functions, living, working, supplying, caring, learning, and enjoying.</p>
                <div className="grid grid-cols-2 gap-8 pt-8">
                  <div>
                    <div className="text-4xl font-bold text-primary mb-2">84%</div>
                    <p className="text-sm font-medium text-slate-500">Reduction in local CO2 emissions within 15-minute pilot zones.</p>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-primary mb-2">2.4x</div>
                    <p className="text-sm font-medium text-slate-500">Increase in local business revenue through pedestrian traffic.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="px-12 max-w-screen-2xl mx-auto my-32">
